...
class App {
    ...
    public static Connection connect() {
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost/mysql?user=root&password=1256nemo");
    ...
    public static void create() {
        try {
            ...
            while (resultSet.next()) {
                ...
                if (databaseName.equals("bibliotheca") || databaseName.equals("Bibliotheca")) {
            ...
            stmt.executeUpdate(
                    "INSERT INTO BOOKS VALUES (191612545,'War and Peace', 'Mystery', 200),  (1250110254,'The Guest Book', 'Fiction', 300), (812914973,'The Perfect Murder','Mystery', 150), (939039695,'Accidental Presidents', 'Biography', 250), (1471408655,'The Wicked King','Fiction', 350)");
